...
export default function PrivateFileItem({user, name, size, id, index}: { user: string, name: string, size: number, id: string, index: number }) {
    return (
        <tr key={index}>
            ...
            <td>
                <div className="flex items-center gap-2">
                    <Image className={'bg-oBlack dark:bg-oWhite bg-opacity-20 dark:bg-opacity-20 rounded'} src={'https://cdn.jsdelivr.net/gh/Tualin14/MyStatic/VscIcons/' + getIconForFile(name)}
                           width={32} height={32}
